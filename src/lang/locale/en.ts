...
const en = {
  ...
  'Set recurring': 'Set recurring',
  'Edit recurring': 'Edit recurring',
  'Remove recurring': 'Remove recurring',
  Daily: 'Daily',
  Weekly: 'Weekly',
  'Every two weeks': 'Every two weeks',
  Monthly: 'Monthly',
  'Add blocker': 'Add blocker',
  'Edit blocker': 'Edit blocker',
  'Remove blocker': 'Remove blocker',
  'Blocker description': 'Blocker description',
  'Describe the blocker…': 'Describe the blocker…',
  'Add tags': 'Add tags',
  'Edit tags': 'Edit tags',
